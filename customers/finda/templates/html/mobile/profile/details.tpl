	<div class="panel active profile profileditor" id="tab-profile-panel">
		...
		<div class="row">
			<div class="column">
				...
				<span class="hide loading"><img src="/images/loading.gif" alt="loading"/> Checking availability</span>
				<span class="hide confirm"><img src="/images/confirm.png" alt="confirm"/> Email Ok</span>
				<span class="hide deny"><img src="/images/deny.png" alt="deny"/> Email address already in use</span>
			</div>
			{if $usertype eq 1}
			<div class="column">
			...
			<div class="column">
				...
				<div class="select-wrap">
					<select name="gender input" id="gender" class="select">
						...
						<option value="other"{if $gender eq 'other'} selected="selected"{/if}>Other</option>
					</select>
				</div>
			</div>
