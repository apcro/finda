...
<div class="row">
	<div class="column">
		<h1 style="transform-origin: left top; margin-bottom: 1em;">Upload New Polaroids</h1>
	</div>
</div>
<div class="row">
	<div class="column">
...
<div class="row">
	<div class="column text-center">
		<p style="margin-top: 2em; margin-bottom: 2em;"><a class="button burgundy" href="/user/polaroids">View all polaroid images</a></p>
	</div>
</div>
{/block}