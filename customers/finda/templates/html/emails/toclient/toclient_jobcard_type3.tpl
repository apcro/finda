...
{/if}
<p style="text-align: center; margin: 0; direction: ltr; color: #000000; line-height: 1.2; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 14px; mso-line-height-alt: 17px;"><span style="font-size: 14px;">Total project cost incl 10% Booking Fee and VAT: £{$fees.totalfee|number_format:2:".":","}</span></p>
<p style="text-align: center; margin: 30px 0 0 0; direction: ltr; color: #000000; line-height: 1.2; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 14px; mso-line-height-alt: 17px;"><span style="font-size: 14px;"><strong>Confirmed Models:</strong></span></p>
{foreach from=$job.models item=model}
{if $model.status eq 2}
<p style="text-align: center; margin: 0; direction: ltr; color: #000000; line-height: 1.2; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 14px; mso-line-height-alt: 17px;"><span style="font-size: 14px;">{$model.firstname} {$model.lastname}</span></p>
{/if}
{/foreach}
...
<p style="text-align: center; margin: 30px 0 0 0; direction: ltr; color: #000000; line-height: 1.2; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 14px; mso-line-height-alt: 17px;"><span style="font-size: 14px;"><strong>A copy of the booking terms is attached to this email.</strong></span></p>
