<form action="/projects/wizardcreate" method="post" id="createjob-form">
	...
	<div class="wizard-container">
		...
		<div class="wizard-step" style="display: none">
			...
			<input type="hidden" name="jobtype input" id="jobtype" value="74">
		</div>
		...
		<div class="wizard-step">
			...
			<div class="row">
				<div class="column">
					<div style="margin-top: 1em; margin-right: 1em;">
						<input type="text" id="length" name="length input" placeholder="Number of days">
				...
				<div class="column">
					<div class="triplet-holder">
						<div class="money">
							<input type="text" id="rate" name="rate input" placeholder="Select a project type" disabled="disabled">
						</div>
						<div class="notmoney">
			...
			<div class="row rateinfo">
				<div class="column">
					<p style="font-size: 90%; margin: 0; padding: 0"><em>1 working day = 5 or more hours.</em></p>
					<p class="minrate_notice"></p>
				</div>
			</div>
			<div class="row rateinfo">
				<div class="column text-left">
					<span class="text-cyan">Per-model fee:</span> <input type="text" id="modelsubtotal" disabled="disabled" /> <span style="font-size: 80%"></span>
				</div>
			</div>
			<div class="row rateinfo">
				<div class="column text-left">
					<span class="text-cyan"><b>Total<span id="modelcounttotal"> for </span>:</b></span> <input type="text" id="ratesubtotal" disabled="disabled" /> <span style="font-size: 80%">Including 10% iDAL fee and 20% VAT</span>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="column">
					<div class="advanced-checkboxes">
						...
						<div class="row">
							<div class="column">
								<h3>Do the influencer models need to post the produced content?</h3>
							</div>
							<div class="column text-right narrow">
								<input class="tgl tgl-slider" id="post_social_media" name="post_social_media" type="checkbox" />
								<label class="tgl-btn" for="model_expenses"></label>	
							</div>
						</div>
		...
		{* final slide *}
		<div class="wizard-step">
			<h2 class="text-center">LET’S SAVE YOUR PROJECT AND FIND MODELS FOR YOU!</h2>
			<div style="width: 100%; padding: 4em; text-align: center">
				<a class="button white fancy createjob">select models</a>
			</div>
		</div>
