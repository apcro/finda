<form action="/projects/wizardcreate" method="post" id="createjob-form">
	<div class="container-header">Discover and Cast Models</div>
	<div class="wizard-container">
		...
		<div class="wizard-step step1">
			<div class="row">
				<div class="column">
					<p>&nbsp;</p>
					<p class="text-center">The details provided in this casting form will be sent to models you request.</p>
					<p class="text-center">If you need to speak to us, please contact us at:<br />Phone: +44 20 8187 7737<br />Email: <a href="mailto:support@idal.co">support@idal.co</a></p>
				</div>
			</div>
		</div>
		...
		<div class="wizard-step step2">
			...
			<div class="row">
				<div class="column">
					<input type="text" id="name" name="name input" placeholder="Casting Name">
				</div>
			</div>
				...
				<div class="column">
					<div class="select-wrap">
						<select name="jobtype input" id="jobtype" class="select">
							...
							<option value="75" data-hourly="0" data-daily="0">Casting</option>
							<option value="78" data-hourly="0" data-daily="0">Go & See</option>
						</select>
					</div>
				</div>
			</div>
		...
		<div class="wizard-step step7">
			<div class="row">
				<div class="column text-center">
					<h1>All done!</h1>
					<h2 style="transform-origin: center;">Save your casting and <span class="modelcountgrammar">find models</span></h2>
