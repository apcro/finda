<form action="/projects/wizardcreate" method="post" id="createjob-form">
	...
	<div class="wizard-container">
		...
		<div class="wizard-step step1">
			<div class="row">
				<div class="column">
					<p class="text-center">The details provided in this booking form will be sent to models you request.</p>
					<p class="text-center">If you need to speak to us, please contact us at:<br />
					Phone: +44 20 8187 7737<br />Email: <a href="mailto:support@idal.co">support@idal.co</a></p>
				</div>
			</div>
		</div>
		...
		<div class="wizard-step skipusage step3">
			<h2>Specify your desired usage rights</h2>
			<div class="row">
				<div class="column">
					<label for="rights_country">Country</label>
					<div class="select-wrap">
						<select name="baseusage" id="standardrights" class="select">
							<option disabled="disabled" selected="selected" value="0">Standard Usage</option>
							<option value="ukrights">United Kingdom</option>
							<option disabled="disabled">Additional Usage</option>
							<option value="eurights">Europe (Include United Kingdom)</option>
							<option value="intrights">Outside Europe</option>
						</select>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="column">
					<label for="rights_country">Period</label>
					<div class="select-wrap">
						<select name="period input" id="period" class="select">
							<option disabled="disabled">Standard Usage</option>
							...
							<option value="48">3+ years</option>
						</select>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="column">
					<div class="base-rights-holder">
						{foreach from=$usagerights item=usage name=usager}
						<div class="row">
{*							<div class="column">{$usage.name}</div> *}
							<div class="column">
								<div class="pretty p-icon p-default">
									<input class="" id="usageright-{$usage.tid}" type="checkbox" name="usagerights[]" value="{$usage.tid}" />
									<div class="state">
										<i class="icon fa fa-check"></i> <label for="usageright-{$usage.tid}">{$usage.name}</label>
									</div>
								</div>
							</div>
						</div>
						{if $smarty.foreach.usager.iteration%5 eq 0}
					</div>
				</div>
				<div class="column">
					<div class="base-rights-holder">
				...
				<div class="column">
					<p class="extrarightsnotice" style="display: none; color: red;">NOTE: You have selected additional usage, please make sure that this is fairly reflected when setting the model rate.</p>
				</div>
			</div>
			<div class="row">
				<div class="column">
					<textarea style="display: none;" id="extrarightsentry" class="extrarightsnotice" name="extrarights input" placeholder="Additional usage rights" rows="4"></textarea>
				</div>
			</div>
		</div>
		
		<div class="wizard-step step4">
			<div class="row">
				<div class="column">
		...
		<div class="wizard-step step5">
			<h2>Please enter your per-model rate for the whole project</h2>
			<p><em>If you want to offer the models a product or service rather than a day rate, please enter 0 here and put your offer in the Job Description</em></p>
		...
		*}
			...
			<div class="row rateinfo">
				<div class="column text-left" style="width: 100%;">
					...
					<br /><span style="font-size: 80%; text-align: center; width: 100%; dipslay: inline-block;">Including 10% Booking fee and 20% VAT</span>
				</div>
			</div>
		</div>

		<div class="wizard-step step6">
			<div class="row">
				<div class="column">
					<h2>Project date</h2>
		...
		<div class="wizard-step step8">
			...
			<p style="color: red;"><em>You can leave these blank and edit them later.</em></p>
		</div>
	
		<div class="wizard-step step9">
			...
			<p class="projectnormal" style="color: red;"><em>This phone number will be provided on the day of your project</em></p>
		</div>
		
		<div class="wizard-step step10">
			...
			<p style="color: red;"><em>Indicate any other details that might be relevant.<span class="zerorate hidden"> Add in any product of other consideration you are offering rather than payment.</span></em></p>
		</div>
		
		<div class="wizard-step step11">
			<div class="row">
				<div class="column text-center">
					<h1>All done!</h1>
					<h2 style="transform-origin: center;">Save your project and <span class="modelcountgrammar">find models</span></h2>
	...
	<input type="hidden" name="daysahead" value="{$smarty.const.FINDA_MINIMUM_DAYS_AHEAD}" />
</form>