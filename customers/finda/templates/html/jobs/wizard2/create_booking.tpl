		...
		<div class="wizard-step" style="display: none">
			<div class="row">
				<div class="column">
					...
					<p class="text-center">Please fill in all necessary information in detail, ensuring the correct project type and usage rights so they can make a decision. In case you need to speak to us, please contact us at:</p>
					<p class="text-center">Phone: +44 844 357 0556<br />Email: <a href="mailto:support@idal.co">support@idal.co</a></p>
				</div>
			</div>
		</div>
		...
		<div class="wizard-step">
			...
			<div class="row rateinfo">
				<div class="column text-left">
					<span>Per-model fee:</span> <input type="text" id="modelsubtotal" disabled="disabled" /> <span style="font-size: 80%"></span>
				</div>
			</div>
			<div class="row rateinfo">
				<div class="column text-left">
					<span><b>Total<span id="modelcounttotal"> for </span>:</b></span> <input type="text" id="ratesubtotal" disabled="disabled" /> <span style="font-size: 80%">Including 10% IDAL fee and 20% VAT</span>
				</div>
			</div>
		</div>
